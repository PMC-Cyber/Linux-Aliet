...
about() {
    { clear; banner; echo; }
	cat <<- EOF
		${GREEN} Author   ${RED}:  ${ORANGE}./B7 ${RED}[ ${ORANGE}PMC MALWARE TEAM ${RED}]
		${GREEN} Github   ${RED}:  ${CYAN}https://github.com/Unlimitid-Crak-You
		${GREEN} Social   ${RED}:  ${CYAN}https://instagram.com/aprizal_febrian
...
${GREEN}     [${WHITE}-${GREEN}]${CYAN} Tool Created by ./B7 (pmc malware team)${WHITE}
	EOF
}
...
main_menu() {
	...
	cat <<- EOF
		...
		${GREEN}┏━━${RED}[${WHITE}01${RED}]${ORANGE} Repositories
		${GREEN}┣━━${RED}[${WHITE}02${RED}]${ORANGE} Dependencies
${GREEN}┣━━${RED}[${WHITE}03${RED}]${ORANGE} GitHub
${GREEN}┗━━${RED}[${WHITE}04${RED}]${ORANGE} Update

		  ${GREEN} > • ${RED}[${WHITE}99${RED}]${ORANGE} About    ${GREEN}> •  ${RED}[${WHITE}00${RED}]${ORANGE} Exit
